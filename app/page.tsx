...
export default function Home() {
  ...
  async function importArxiv(raw: string, convertPdfToLatex = false, correctnessAudit = true, detailedAudit = true) {
    ...
    try {
      ...
      await analyzePaper(stored, convertPdfToLatex, correctnessAudit, detailedAudit);
...
function ProcessTray({ analysis, profile, bridge, retryAudit }: { analysis: AnalysisProgress | null; profile: Profile; bridge: Bridge | null; retryAudit: (paperId: string) => void }) {
